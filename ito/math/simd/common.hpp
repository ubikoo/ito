...
#ifndef ITO_MATH_SIMD_COMMON_H_
#define ITO_MATH_SIMD_COMMON_H_
...
ito_inline __m128d simd128_reverse_(__m128d a)
{
     ...
     * {a1, a0} -> {a0, a1}
     */
    return _mm_permute_pd(a, ito_extension(0b01));
}
...
ito_inline __m256d simd256_reverse_(__m256d a)
{
     ...
     */
    __m256d v = _mm256_permute_pd(a, ito_extension(0b0101));      /* 0x5 */
    /*
     * {a3, a2, a1, a0} -> {a1, a0, a3, a2}
     */
    return _mm256_permute2f128_pd(v, v, ito_extension(0b0001));  /* 0x1 */
}
...
ito_inline void simd128_transpose_(__m128d(&row)[2])
{
     ...
     * t1 = {a3, a1}
     */
    __m128d t0 = _mm_shuffle_pd(r0, r1, ito_extension(0b00));
    __m128d t1 = _mm_shuffle_pd(r0, r1, ito_extension(0b11));
...
ito_inline void simd256_transpose_(__m256d (&row)[4])
{
     ...
     */
    __m256d r4 = _mm256_permute2f128_pd(r2, r2, ito_extension(0b00000001));
    __m256d r5 = _mm256_permute2f128_pd(r3, r3, ito_extension(0b00000001));
    /*
     * p1 = { a6, a2,  a4,  a0}
     * p2 = { a7, a3,  a5,  a1}
     * p3 = {a12, a8, a14, a10}
     ...
     */
    __m256d t0 = _mm256_permute2f128_pd(p1, p3, ito_extension(0b00110000));
    __m256d t1 = _mm256_permute2f128_pd(p2, p4, ito_extension(0b00110000));
    __m256d t2 = _mm256_permute2f128_pd(p1, p3, ito_extension(0b00010010));
    __m256d t3 = _mm256_permute2f128_pd(p2, p4, ito_extension(0b00010010));
    /*
     * t4 = {a14, a10, a6,  a2}   (t2, t2) (mask[5:4] = 0, mask[1:0] = 1)
     * t5 = {a15, a11, a7,  a3}   (t3, t3) (mask[5:4] = 0, mask[1:0] = 1)
     */
    __m256d t4 = _mm256_permute2f128_pd(t2, t2, ito_extension(0b00000001));
    __m256d t5 = _mm256_permute2f128_pd(t3, t3, ito_extension(0b00000001));
...
ito_inline __m256d simd256_det_(__m256d a)
{
    ...
    __m256d r3 = _mm256_permute_pd(r2, ito_extension(0b0110));
